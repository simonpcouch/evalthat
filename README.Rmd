...
* The usual testing file is wrapped in a `function()` and invoked at the end of the file with `if (exists("chat")) chat else ellmer::chat_claude()`, a shorthand that allows for testthat to programatically pass in chats from other providers but default to `ellmer::chat_claude()`.
